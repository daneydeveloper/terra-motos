...
<html lang="pt-BR">
                        ...
                        <div class="col-lg-12 col-md-12">
                           ...
                           <ul class="menu-links">
                              ...
                              <li class="active">
                                 ...
                                 <!-- drop down multilevel  -->
                                 <ul class="drop-down-multilevel">
                                    <li class="active"><a href="details-01.html">details 01</a></li>
            ...
            <div class="row">
               <div class="col-lg-12 col-md-12">
                  <div class="details-nav">
                     <ul>
                        <li>
                           <a data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo" href="#" class="css_btn"><i class="fa fa-question-circle"></i>Request More Info</a>
                           ...
                           <div class="modal fade" id="exampleModal5" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                              <div class="modal-dialog" role="document">
                                 <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                       <form class="gray-form row reset_css" action="http://themes.potenzaglobalsolutions.com/html/cardealer/post" id="tia_form">
                                          <div class="row">
                                             <div class="col-lg-6 col-md-6">
                                          ...
                                          <div class="row">
                                             <div class="col-lg-12 col-md-12">
                                                <div class="col-lg-12 col-md-12 vehicle-assessment">
   ...
   <!-- Mirrored from themes.potenzaglobalsolutions.com/html/cardealer/details-01.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 28 Dec 2017 12:39:17 GMT -->
</html>